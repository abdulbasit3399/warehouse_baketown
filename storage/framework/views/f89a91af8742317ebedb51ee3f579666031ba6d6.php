...
<body class="<?php echo e($color); ?>" dir="<?php echo e(env('SITE_RTL') == 'on'?'rtl':''); ?>">
<!-- [ Nav ] start -->
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    ...
                    >
                    <a href="https://codecanyon.net/item/accountgo-accounting-and-billing-tool/25725131?s_rank=28" class="btn btn-outline-light" target="_blank"
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                <p class="text-body"><?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright AccountGo')); ?> <?php echo e(date('Y')); ?></p>
            </div>
        </div>
    </div>
</section>
...
<?php /**PATH C:\laragon\www\warehouse_baketown\resources\views/layouts/landing.blade.php ENDPATH**/ ?>