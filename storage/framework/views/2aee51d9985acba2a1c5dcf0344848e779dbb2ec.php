    ...
    <ul class="list-unstyled">
        ...
        <li class="dropdown dash-h-item drp-company">
            ...
            <span class="theme-avtar">
                ...
                <img src="<?php echo e($profile . (isset(\Auth::user()->avatar) && !empty(\Auth::user()->avatar)? \Auth::user()->avatar:'logo-dark.png')); ?>" class="img-fluid rounded-circle">
            <?php else: ?>
                    ...
                    <div class="dropdown notification-icon">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownBookmark">
                                ...
                                <?php if(Gate::check('create customer')): ?>
                                    <a class="dropdown-item" href="#" data-url="<?php echo e(route('customer.create')); ?>" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create New Customer')); ?>"><i class="ti ti-user"></i><?php echo e(__('Create New Customer')); ?></a>
                                <?php endif; ?>
                                <?php if(Gate::check('create vender')): ?>
                                    <a class="dropdown-item" href="#" data-url="<?php echo e(route('vender.create')); ?>" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create New Vendor')); ?>"><i class="ti ti-note"></i><?php echo e(__('Create New Vendor')); ?></a>
                                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\warehouse_baketown\resources\views/partials/admin/header.blade.php ENDPATH**/ ?>