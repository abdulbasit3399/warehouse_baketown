...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('vender.statement',$vendor['id'])); ?>" class="btn btn-sm btn-primary">
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card pb-0">
                <div class="card-body">
                    <h3 class="card-title"><?php echo e(__('Company Info')); ?></h3>
                    <div class="row">
                        <?php
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('duplicate bill')): ?>
                                                    ...
                                                    <?php echo Form::open(['method' => 'get', 'route' => ['bill.duplicate', $bill->id],'id'=>'duplicate-form-'.$bill->id]); ?>
                                                        ...
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip"  title="<?php echo e(__('Duplicate Bill')); ?>" data-original-title="<?php echo e(__('Duplicate')); ?>" data-confirm="<?php echo e(__('You want to confirm convert to invoice. Press Yes to continue or Cancel to go back')); ?>" data-confirm-yes="document.getElementById('duplicate-form-<?php echo e($bill->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\thebaketown\resources\views/vender/show.blade.php ENDPATH**/ ?>