...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="#" data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Import')); ?>" data-url="<?php echo e(route('invoice.file.import')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Import invoice CSV file')); ?>" class="btn btn-sm btn-primary">
