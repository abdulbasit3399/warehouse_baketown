...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <img id="image" class="mt-2" src="<?php echo e(asset(Storage::url('uploads/revenue/'.$revenue->add_receipt))); ?>" style="width:25%;"/>
        </div>
...
<?php /**PATH C:\laragon\www\thebaketown\resources\views/revenue/edit.blade.php ENDPATH**/ ?>