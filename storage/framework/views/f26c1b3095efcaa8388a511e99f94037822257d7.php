                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="col col-lg-3 col-md-6 col-sm-12 col-12 ">
                                <div class="btn-box">
                                    <?php echo e(Form::text('date', isset($_GET['date'])?$_GET['date']:null, array('class' => 'month-btn form-control pc-datepicker-1','id'=>'pc-daterangepicker-1','placeholder'=>'YYYY-MM-DD'))); ?>
                            ...
                            <div class="col-auto float-end ms-2">
                                ...
                                <a href="<?php echo e(route('revenue.index')); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" data-original-title="<?php echo e(__('Reset')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\warehouse_baketown\resources\views/revenue/index.blade.php ENDPATH**/ ?>