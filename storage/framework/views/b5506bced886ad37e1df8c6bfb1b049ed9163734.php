        ...
        <div class="row">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0"><?php echo e(__('Transaction Summary')); ?></h6>
                </div>
            </div>
                ...
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="card p-4 mb-4">
                        <?php if($account->holder_name =='Cash'): ?>
                            <h6 class="report-text gray-text mb-0"><?php echo e($account->holder_name); ?></h6>
                        <?php elseif(empty($account->holder_name)): ?>
                            <h6 class="report-text gray-text mb-0"><?php echo e(__('Stripe / Paypal')); ?></h6>
                        <?php else: ?>
                            <h6 class="report-text gray-text mb-0"><?php echo e($account->holder_name.' - '.$account->bank_name); ?></h6>
                        <?php endif; ?>
                        <h7 class="report-text mb-0"><?php echo e(\Auth::user()->priceFormat($account->total)); ?></h7>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\thebaketown\resources\views/transaction/index.blade.php ENDPATH**/ ?>