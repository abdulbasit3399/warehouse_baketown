    ...
    <div id="printableArea">
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0"><?php echo e(__('Ledger Summary')); ?></h6>
                </div>
            </div>
        ...
        <?php if(!empty($account)): ?>
            <div class="row mt-3">
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0"><?php echo e(__('Account Name')); ?> :</h7>
                        <h6 class="report-text mb-0"><?php echo e($account->name); ?></h6>
                    </div>
                </div>

                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0"><?php echo e(__('Account Code')); ?> :</h7>
                        <h6 class="report-text mb-0"><?php echo e($account->code); ?></h6>
                    </div>
                </div>
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0"><?php echo e(__('Total Debit')); ?> :</h7>
                        <h6 class="report-text mb-0"><?php echo e(\Auth::user()->priceFormat($filter['debit'])); ?></h6>
                    </div>
                </div>
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0"><?php echo e(__('Total Credit')); ?> :</h7>
                        <h6 class="report-text mb-0"><?php echo e(\Auth::user()->priceFormat($filter['credit'])); ?></h6>
                    </div>
                </div>

                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0"><?php echo e(__('Balance')); ?> :</h7>
                        <h6 class="report-text mb-0"><?php echo e(($filter['balance']>0)?__('Cr').'. '.\Auth::user()->priceFormat(abs($filter['balance'])):__('Dr').'. '.\Auth::user()->priceFormat(abs($filter['balance']))); ?></h6>
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\thebaketown\resources\views/report/ledger_summary.blade.php ENDPATH**/ ?>