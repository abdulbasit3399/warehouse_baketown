                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right" style="position: relative;">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\App\Models\Utility::proposalNumberFormat($settings,$proposal->proposal_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(\App\Models\Utility::dateFormat($settings,$proposal->issue_date)); ?></td>
                                            </tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::priceFormat($settings,$proposal->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::priceFormat($settings,$proposal->totalTaxPrice)); ?></pre>
                                                </div>
                                                
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::priceFormat($settings,$proposal->totalDiscount)); ?></pre>
                                                    </div>
                                                ...
                                                <div class="d-table-td w-4 text-end">
                                                    <span><?php echo e(\App\Models\Utility::priceFormat($settings,$proposal->getSubTotal())); ?>
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                        ...
                                                        <?php if($proposal->getTotalDiscount()): ?>
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::priceFormat($settings,$proposal->getTotalDiscount())); ?></div>
                                                            </div>
                                                        <?php endif; ?>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::priceFormat($settings,$proposal->getSubTotal()-$proposal->getTotalDiscount()+$proposal->getTotalTax())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH C:\laragon\www\warehouse_baketown\resources\views/proposal/templates/template1.blade.php ENDPATH**/ ?>