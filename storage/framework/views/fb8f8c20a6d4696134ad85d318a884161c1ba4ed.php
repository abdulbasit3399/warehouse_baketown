                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right" style="position:relative;">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\App\Models\Utility::billNumberFormat($settings,$bill->bill_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(\App\Models\Utility::dateFormat($settings,$bill->bill_date)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Due Date')); ?>:</td>
                                                <td><?php echo e(\App\Models\Utility::dateFormat($settings,$bill->due_date)); ?></td>
                                            </tr>
                                            <tr class="ml-8" style="position: absolute; right: 0;">
                                                <td class="">
                                                    <p> <?php echo DNS2D::getBarcodeHTML(route('pay.billpay',\Illuminate\Support\Facades\Crypt::encrypt($bill->id)), "QRCODE",2,2); ?></p>
                                                </td>
                                            </tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::priceFormat($settings,$bill->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::priceFormat($settings,$bill->totalTaxPrice)); ?></pre>
                                                </div>
                                               
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::priceFormat($settings,$bill->totalDiscount)); ?></pre>
                                                    </div>
                                                ...
                                                <div class="d-table-td w-4 text-end">
                                                    <span><?php echo e(\App\Models\Utility::priceFormat($settings,$bill->getSubTotal())); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::priceFormat($settings,$bill->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($bill->getTotalDiscount()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::priceFormat($settings,$bill->getTotalDiscount())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::priceFormat($settings,$bill->getSubTotal()-$bill->getTotalDiscount()+$bill->getTotalTax())); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Paid')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::priceFormat($settings,($bill->getTotal()-$bill->getDue())-($bill->billTotalDebitNote()))); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Debit Note')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::priceFormat($settings,($bill->billTotalDebitNote()))); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::priceFormat($settings,$bill->getDue())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php /**PATH C:\laragon\www\warehouse_baketown\resources\views/bill/templates/template1.blade.php ENDPATH**/ ?>