                            ...
                            <div class="timeline timeline-one-side" data-timeline-content="axis" data-timeline-axis-style="dashed">
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        @can('edit invoice')
                                            <div class="Action">
                                                <a href="{{ route('retainer.edit',\Crypt::encrypt($retainer->id)) }}" class="mx-3 btn btn-sm align-items-center float-right" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="ti ti-edit text-white"></i></a>
                                            </div>
                                        @endcan
                                ...
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        @if ($retainer->status == 0)
                                            <div class="Action">
                                                @can('send invoice')
                                                    <a href="{{ route('retainer.sent',$retainer->id) }}" class="send-icon float-right" data-toggle="tooltip" data-original-title="{{__('Mark Sent')}}"><i class="fa fa-paper-plane"></i></a>
                                                @endcan
                                            </div>
                                        @endif
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        @if ($retainer->status != 0)
                                            @can('create payment invoice')
                                                <a href="#" data-url="{{ route('retainer.payment',$retainer->id) }}" data-ajax-popup="true" data-title="{{__('Add Receipt')}}" class="mx-3 btn btn-sm align-items-center float-right" data-toggle="tooltip" data-original-title="{{__('Add Receipt')}}"><i class="far fa-file"></i></a>
                                            @endcan
                                        @endif
            ...
            <div class="col-10 d-flex align-items-center justify-content-between justify-content-md-end">
                ...
                {{-- @if ($invoice->status != 4)
                 ...
                 <div class="all-button-box mr-3">
                    <a href="{{ route('retainer.pdf', Crypt::encrypt($retainer->id)) }}" target="_blank" class="btn btn-primary">{{ __('Download') }}</a>
                                ...
                                @endif
                                    ...
                                    <div class="col">
                                        <div class="float-end mt-3">
                                            {!! DNS2D::getBarcodeHTML(route('pay.retainerpay', \Illuminate\Support\Facades\Crypt::encrypt($retainer->id)), 'QRCODE', 2, 2) !!}
                                        </div>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('edit credit note')
                                            <a data-url="{{ route('retainer.edit.credit.note', [$creditNote->retainer, $creditNote->id]) }}"
                                        ...
                                        @can('delete credit note')
                                            ...
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['retainer.delete.credit.note', $creditNote->retainer, $creditNote->id], 'id' => 'delete-form-' . $creditNote->id]) !!}
                                            {!! Form::close() !!}
                                        @endcan
                                    </td>
                                </tr>
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    @if (!empty($company_payment_setting) && ($company_payment_setting['is_stripe_enabled'] == 'on' && !empty($company_payment_setting['stripe_key']) && !empty($company_payment_setting['stripe_secret'])))
                                        <div class="tab-pane fade active show" id="stripe-payment" role="tabpanel"
                                            ...
                                            <form method="post"
                                                action="{{ route('customer.invoice.payment', $retainer->id) }}"
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input class="form-control" required="required" min="0"
                                                                ...
                                                                value="{{ $retainer->getDue() }}" min="0" step="0.01"
                                                                max="{{ $retainer->getDue() }}" id="amount">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-prepend"><span
                                                                class="input-group-text">{{ App\Models\Utility::getValByName('site_currency') }}</span></span>
                                                        <input class="form-control" required="required" min="0"
                                                            name="amount" type="number" value="{{ $retainer->getDue() }}"
                                                            min="0" step="0.01" max="{{ $retainer->getDue() }}"
                                                            id="amount">
                                                ...
                                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <span class="input-group-prepend">
                                                            ...
                                                            <input class="form-control" required="required" min="0"
                                                                   name="amount" type="number" value="{{ $retainer->getDue() }}"
                                                                   min="0" step="0.01" max="{{ $retainer->getDue() }}" id="amount">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 form-group mt-3 text-end">
                                                        <input class="btn btn-sm btn-primary m-r-10"
