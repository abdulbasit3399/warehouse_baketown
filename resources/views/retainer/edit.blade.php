                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (proposalItems != null) {
                                ...
                                el.parent().parent().siblings('.item-discount').find('.discount').val(proposalItems.discount);
                                // $(el.parent().parent().find('.discount')).val(proposalItems.discount);
                            } else {
                                $(el.parent().parent().find('.quantity')).val(1);
                                $(el.parent().parent().find('.price')).val(item.product.sale_price);
                                el.parent().parent().siblings('.item-discount').find('.discount').val(0);
...
@section('content')
    <div class="row">
        {{ Form::model($retainer, array('route' => array('retainer.update', $retainer->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6">
                                    <div class="custom-control custom-checkbox mt-4">
                                        <input class="custom-control-input" type="checkbox" name="discount_apply" id="discount_apply" {{$retainer->discount_apply==1?'checked':''}}>
                                        <label class="custom-control-label form-label" for="discount_apply">{{__('Apply Discount')}}</label>
                                    </div>
                                </div> -->
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
        ...
        <div class="modal-footer">
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("retainer.index")}}';" class="btn btn-light">
