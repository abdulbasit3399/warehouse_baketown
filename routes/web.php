...
Route::get('retainer/items/', 'RetainerController@items')->name('retainer.items');
...
Route::prefix('customer')->as('customer.')->group(
    function () {
        ...
        Route::get('/invoice/razorpay/{pay_id}/{invoice_id}', ['as' => 'invoice.razorpay', 'uses' => 'RazorpayPaymentController@getInvoicePaymentStatus']);
...
Route::group(
    ...
    function () {
        ...
        Route::get('proposal/{id}/convertinvoice', 'ProposalController@convertInvoice')->name('proposal.convertinvoice');
